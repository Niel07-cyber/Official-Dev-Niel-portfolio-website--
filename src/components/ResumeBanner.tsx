  ...
  return (
    <section className="py-20 bg-background">
      <div className="max-w-6xl mx-auto px-4">
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 dark:from-gray-900 dark:to-gray-800 rounded-2xl p-12 text-center relative overflow-hidden">
          {/* Background pattern */}
          ...
          <div className="relative z-10">
            ...
            <a 
              href="/resume" 
              className="inline-flex items-center px-8 py-4 bg-white text-gray-900 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
            >
